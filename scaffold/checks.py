...
check_csp_sources_not_unsafe.messages = {src + "_UNSAFE": "Please remove 'unsafe-inline'/'unsafe-eval' from " + src for
                                         src in CSP_SOURCE_NAMES}
